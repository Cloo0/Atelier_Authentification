...
if (isset($_COOKIE['authToken']) && $_COOKIE['authToken'] === $username) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username === 'admin' && $password === 'secret') {
        setcookie('authToken', $_SESSION['token'], time() + 60, '/', '', false, true); // Le Cookie est initialisé et valable pendant 1 minute (60 secondes) 
